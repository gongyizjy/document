...
export default function ColumnsMenu({ editor, appendTo }: MenuProps) {
  ...
  return (
    ...
    >
      <Toolbar.Wrapper>
        <Toolbar.Button tooltip="左侧栏" active={isColumnLeft} onClick={onColumnLeft}>
          <Icon name="PanelLeft" />
        </Toolbar.Button>
        <Toolbar.Button tooltip="两栏" active={isColumnTwo} onClick={onColumnTwo}>
          <Icon name="Columns2" />
        </Toolbar.Button>
        <Toolbar.Button tooltip="右侧栏" active={isColumnRight} onClick={onColumnRight}>
